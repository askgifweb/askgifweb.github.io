...
$_LANG['domainssearchresults'] = "Rezultatele Căutări";
...
$_LANG['ticketinfo'] = "Informații Tichete";
...
$_LANG['cPanel']['addonsExtras'] = "Adonuri și Optiuni Suplimentare";
$_LANG['cPanel']['purchaseActivate'] = "Comanda";

$_LANG['cPanel']['usageStats'] = "Usage Statistics";
$_LANG['cPanel']['diskUsage'] = "Consum Spatiu";
$_LANG['cPanel']['bandwidthUsage'] = "Consum Trafic";
...
$_LANG['cPanel']['quickShortcuts'] = "Scurtaturi cPanel";
...
$_LANG['cPanel']['createEmailAccount'] = "Creaza Rapid Cont E-Mail";
$_LANG['cPanel']['usernamePlaceholder'] = "Userul";
$_LANG['cPanel']['passwordPlaceholder'] = "Parola";
$_LANG['cPanel']['create'] = "Creaza";
...
$_LANG['cPanel']['billingOverview'] = "Informații Facturare";
...
$_LANG['billingAddress'] = "Adresă Facturare";

$_LANG['noPasswordResetWhenLoggedIn'] = "Nu poți cere resetarea parolei atunci cand sunteți logat. Vă rugam sa vă delogați.";

$_LANG['unableToLoadShoppingCart'] = "Imposibil de încărcat coșul de cumpărături. Vă rugăm să contactați echipa de suport.";
...
$_LANG['orderForm']['findNewDomain'] = "Introduceti numele de domeniu pe care doriti sa-l inregistrati si verificati disponibilitatea lui, daca este liber la inregistrare puteti urma pasii de comanda sau puteti verifica un alt nume de domeniu.";
$_LANG['orderForm']['transferExistingDomain'] = "Transferă domeniul existent.";
$_LANG['orderForm']['www'] = "www.";
$_LANG['orderForm']['check'] = "Bifați";
$_LANG['orderForm']['returnToClientArea'] = "Înapoi Arie Client";
$_LANG['orderForm']['checkout'] = "Finalizați Comanda";
$_LANG['orderForm']['alreadyRegistered'] = "Deja înregistrat?";
$_LANG['orderForm']['createAccount'] = "Creați un cont nou";
$_LANG['orderForm']['enterPersonalDetails'] = "Vă rugăm să introduceți datele dumneavoastră personale și informațiile de facturare la finalizare comandă.";
...
$_LANG['orderForm']['domainAlternativeContact'] = "Puteți specifica alternative detalii de contact să le folosiți pentru înregistrare de domenii, în scopul când plasați o comandă în numele unei alte persoane sau entități. Dacă nu aveți nevoie de acest lucru, puteți sări peste această secțiune.";
$_LANG['orderForm']['accountSecurity'] = "Cont de Securitate";
$_LANG['orderForm']['mediumStrength'] = "Forța medie";
$_LANG['orderForm']['paymentDetails'] = "Detalii de Plată";
$_LANG['orderForm']['preferredPaymentMethod'] = "Vă rugăm să alegeți metoda de plată preferată.";
$_LANG['orderForm']['cardNumber'] = "Număr de Card";
$_LANG['orderForm']['cvv'] = "CVV Număr de Securitate";
$_LANG['orderForm']['additionalNotes'] = "Note Adiționale";
$_LANG['orderForm']['continueToClientArea'] = "Continuați către Arie Client";
$_LANG['orderForm']['reviewDomainAndAddons'] = "Vă rugăm să revizuiți domenile selectate și orice addons disponibil.";
$_LANG['orderForm']['addToCart'] = "Adaugă în coș";
$_LANG['orderForm']['addedToCartRemove'] = "Adăugat în coș (Eliminare)";
$_LANG['orderForm']['configureDesiredOptions'] = "Configurați opțiunile dorite și continuați către finalizare comandă.";
$_LANG['orderForm']['haveQuestionsContact'] = "Aveți întrebări? Contactați echipa noastră de vânzări pentru asistență.";
...
$_LANG['orderForm']['registerLongerAndSave'] = "Inregistreaza-te pentru mai mult timp și câștigați!";
$_LANG['orderForm']['tryRegisteringInstead'] = "Încercați înregistrarea acestui domeniu în loc.";
$_LANG['orderForm']['domainAvailabilityCached'] = "Disponibilitate de domenii sunt în cache, care ar putea duce la domenii recent înregistrate ca elemente de disponibil.";
$_LANG['orderForm']['submitTicket'] = "Trimite un Tichet";
$_LANG['orderForm']['promotionAccepted'] = "Cod Promoțional Acceptat! Totalul din comanda dumneavoastră a fost actualizat.";
$_LANG['orderForm']['productOptions'] = "Produs/Opțiuni";
$_LANG['orderForm']['qty'] = "Qty";
$_LANG['orderForm']['priceCycle'] = "Preț/Perioadă";
$_LANG['orderForm']['edit'] = "Editați";
$_LANG['orderForm']['update'] = "Actualizați";
$_LANG['orderForm']['remove'] = "Șterge";
$_LANG['orderForm']['applyPromoCode'] = "Code promoție";
$_LANG['orderForm']['estimateTaxes'] = "Extimare taxe";
$_LANG['orderForm']['removePromotionCode'] = "Ștergere cod promoție";
$_LANG['orderForm']['updateTotals'] = "Actualizați Totaluri";
$_LANG['orderForm']['continueShopping'] = "Continuați cumpărăturile";
$_LANG['orderForm']['removeItem'] = "Șterge articol";
$_LANG['orderForm']['yes'] = "Da";
$_LANG['orderForm']['cancel'] = "Anulați";
$_LANG['orderForm']['close'] = "Închide";
$_LANG['orderForm']['totals'] = "Totaluri";
$_LANG['orderForm']['includedWithPlans'] = "Inclus cu Fiecare Plan";
