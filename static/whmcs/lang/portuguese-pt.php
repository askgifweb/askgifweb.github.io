...
$_LANG['ordererrorservernonameservers'] = "Tem que digitar um prefixo para os dois Servidores de Domínio";
...
$_LANG['orderservernameserversdescription'] = "Os prefixos que digitar aqui irão determinar os Servidores de Dominio para o seu servidor. Ex: ns1.example.com e ns2.example.com";
...
$_LANG['quotefinalpayment'] = "Balanço de Depositos";
...
$_LANG['invoicepaymentpendingreview'] = "Obrigado! O seu pagamento foi bem sucedido e sera aplicado na sua fatura, logo que o processo de revisão da 2CheckOut estiver concluído.<br /><br />Poderá levar ate algumas horas pelo que solicitamos sua compreensão porque sera realizado no mais breve curto espaço de tempo";
...
$_LANG['forgotpw'] = "Não se lembra da password?";
...
$_LANG['domainaddonsinfo'] = "Os seguintes addons estão disponíveis para o seu domínio…";
$_LANG['domainaddonsdnsmanagement'] = "Gestão de DNS";
$_LANG['domainaddonsidprotectioninfo'] = "Proteja-se contra o SPAM activado a protecção de identidade do domínio.";
...
$_LANG['newsletterunsubscribe'] = "Newsletter Deactivada";
...
$_LANG['pwresetsuccessdesc'] = "A sua password foi reposta com sucesso. %sClique Aqui%s para entrar na área de cliente…";
$_LANG['pwresetenternewpw'] = "Por favor introduza a sua nova password.";
...
$_LANG['twofaactivationintro'] = "A autenticação de dois passos aumenta a segurança da sua conta, adicionando um passo adicional à tradicional password. Uma vez activada &amp; e configurada, todas as vezes que fizer login ser-lhe-a pedido um código adicional.";
$_LANG['twofaactivationmultichoice'] = "Para continuar seleccione o tipo de autenticação de dois passos que pretende..";
$_LANG['twofadisableintro'] = "Por favor introduza a sua password para desactivar a autenticação de dois passos.";
...
$_LANG['twofaconfirmpw'] = "Introduza a password";
...
$_LANG['twoiptimebasedpassword'] = "Password única baseada na data";
...
$_LANG['announcementsolder'] = "Anúncios anterioires";
...
$_LANG['sidebars']['viewAccount']['billingInformation'] = "informação de Facturação";
...
$_LANG['aboutsecurityquestions'] = "Porque as perguntas de segurança?";
...
$_LANG['billingdetails'] = "Definições de facturação";
$_LANG['homechooseproductservice'] = "Escolha um produto/serviço para gerir:";

$_LANG['invoicesdue'] = "Facturas Pendentes";
$_LANG['invoicesduemsg'] = "Tem %s factura(s) por pagar, com um balanço pendente de %s";
$_LANG['noinvoicesduemsg'] = "Não tem facturas por pagar.";
...
$_LANG['nodomainextensions'] = "Não tem nenhuma extensão de domínio selectionada";
...
$_LANG['passwordtips'] = "<strong>Dicas para uma boa password</strong><br />Utilize caracteres maiúsculos e minúsculos<br />Utilize pelo menos um símbolo (# $ ! % &amp; etc...)<br />Não use palavras constantes no dicionário";
...
$_LANG['tldpricing'] = "Preço da extençao";
...
$_LANG['pwresetemailneeded'] = "Esqueceu a password? Introduza o seu email para podermos ajudar.";
...
$_LANG['invoicelineitems'] = "Linhas Facturadas";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Tem :numberOfInvoices factura(s) pendente(s).";
...
$_LANG['clientHomePanels']['unpaidInvoices'] = "Facturas não pagas";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Tem :numberOfInvoices facturas por pagar, num valor total de :balanceDue.";
...
$_LANG['clientHomePanels']['activeProductsServices'] = "Os seus produtos/serviços activos";
...
$_LANG['domainchecker']['suggestiontakenmsg'] = "Infelizmente o domínio não está disponíve.";
...
$_LANG['licensingaddon']['mylicenses'] = "As Minhas Licensas";
...
$_LANG['projectManagement']['activeProjects'] = "Os seus projectos activos";

# cPanel Module

$_LANG['cPanel']['packageDomain'] = "Pacote/Domínos";
...
$_LANG['cPanel']['bandwidthUsage'] = "Tráafego";
...
$_LANG['cPanel']['forwarders'] = "Reencaminhar…";
...
$_LANG['cPanel']['usernamePlaceholder'] = "Nome de utilzador";
...
$_LANG['cPanel']['statusPendingNotice'] = "Não pode utilizar este alojamento até estar activado.";
$_LANG['cPanel']['statusSuspendedNotice'] = "Não pode voltar a utilizar ou alterar este alojamento até ser reactivado.";

$_LANG['cPanel']['billingOverview'] = "Visão Geral da Facturação";

$_LANG['liveHelp']['chatNow'] = "Fale Connosco";

$_LANG['quotes'] = "Orçamentos";

$_LANG['productMustBeActiveForModuleCmds'] = "O produto tem de estar activado para fazer esta alteração";
$_LANG['domainCannotBeManagedUnlessActive'] = "Domínio não está activo. Não é possível fazer alterações.";
...
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "Ao definir uma questão de segurança está a proteger-se contra pedidos de reset de password e alterações indesejadas na sua conta.";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "Ao definir uma questão de segurança está a proteger-se contra pedidos de reset de password e alterações indesejadas na sua conta.";

$_LANG['billingAddress'] = "Endereço de Facturação";

$_LANG['noPasswordResetWhenLoggedIn'] = "Não pode pedir uma password nova enquanto tem o login feito.";
...
$_LANG['shoppingCartProductPerMonth'] = "<span>:priice</span>/:countmo";
...
$_LANG['orderForm']['enterPersonalDetails'] = "Por favor preencha os detalhes para finalizar.";
...
$_LANG['orderForm']['billingAddress'] = "Endereço de Facturação";
...
$_LANG['orderForm']['haveQuestionsContact'] = "Dúvidas? Entre em contacto connosco.";
...
$_LANG['sso']['disablenotice'] = "Pode querer desactivar este funcionalidade, caso exista alguém com acesso a uma das aplicações autorizadas para utilizar a funcionalidade Single Sign-On, mas que não deva ter acesso aos seus dados de facturação desta pagina.";
