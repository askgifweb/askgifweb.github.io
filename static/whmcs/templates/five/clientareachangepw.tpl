...
<form class="form-horizontal" method="post" action="{$smarty.server.PHP_SELF}?action=changepw">
  ...
  <fieldset class="onecol">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="password" name="existingpw" id="existingpw" autocomplete="off" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="password" name="newpw" id="password" autocomplete="off" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="password" name="confirmpw" id="confirmpw" autocomplete="off" />
        </div>
    </div>
